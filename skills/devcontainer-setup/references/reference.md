# Devcontainer Setup — Full Reference

> The complete new-setup, verification, and audit flows for the
> `devcontainer-setup` skill. `SKILL.md` is the lean process that points
> here; this file holds every file template, rule, and checklist.
