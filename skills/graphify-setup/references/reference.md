...
> The complete new-setup and audit flows for the `graphify-setup` skill.
> `SKILL.md` is the lean process that points here; this file holds every
> step, command, and rule.
