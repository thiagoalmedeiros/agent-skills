---
description: "Build the next slice — implement against the project's coding standards, one reviewable batch at a time. [Copilot: GPT-5.6 Luna → escalate GPT-5.3-Codex]"
---
